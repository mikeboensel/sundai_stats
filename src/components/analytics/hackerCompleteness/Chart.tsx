...
/**
 * HackerCompleteness Chart (Pie set)
 */
...
export default function HackerCompletenessChart({
  data,
}: {
  data: HackerCompletenessPercents;
}) {
  return (
    <section style={{ marginTop: 24 }}>
      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>
        Hacker Account Completeness
      </h2>
      <p style={{ color: "#6b7280", marginBottom: 16 }}>
        Population size: {data.totalHackers.toLocaleString()} hackers
      </p>
      <div
        style={{
          display: "grid",
